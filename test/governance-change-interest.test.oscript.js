...
describe('Governance change interest rate', function () {
	...
	//	await this.network.witnessUntilStable(response.response_unit)
		...
		expect(cvars['growth_factor'].toPrecision(8)).to.be.equal((1.1**(185/360)).toPrecision(8))
	})
	...
	it('1 year later, Alice buys more of the tokens2', async () => {
		...
		expect(time_error).to.be.undefined
		this.target_p2 = 1/this.price * 1.1**((180+5)/360) * 1.2**((30+360)/360)
